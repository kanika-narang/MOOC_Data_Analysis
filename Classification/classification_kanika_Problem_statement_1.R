...
# plotting how the yoB and certified are related
p = ggplot(student_data_dataverse,aes(x=YoB,  
                    y=certified, 
                    color=certified))
...
# plotting how the last_event_DI and certified are related
p = ggplot(student_data_dataverse,aes(x=last_event_DI,  
                                      y=certified, 
                                      color=certified))
